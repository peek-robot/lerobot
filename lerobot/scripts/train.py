...
def train(cfg: TrainPipelineConfig):
    ...
    policy = make_policy(
        ...
        remap_keys=dataset.remap_keys,  # This remaps dataset keys to keys used for the policy since some of them are hardcoded.
        drop_keys=dataset.drop_keys,  # This drops keys from the dataset.
    )
